...
class BackgroundHandler:
	...
	def __init__(self, camWidth, camHeight, rescale=8, mode=None, alt_image_path='back.jpg', blur_kernel_size=9, mask_smooth_kernel_size=11, mask_smooth_iters=2, update_iters=10):
